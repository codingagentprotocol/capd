...
func TestAccountsCheckCanRefreshQuotaAndEnforceReadiness(t *testing.T) {
	...
	if !result.Summary.Ready || result.Summary.CheckedAccounts != 2 || result.Summary.MissingAccounts != 0 || result.Summary.FreshQuotaAccounts != 2 || !result.Summary.AutoRouteFresh || !result.Summary.RouteDecisionOK || result.Summary.RequiredSecretBackend != secret.BackendFile || !result.Summary.SecretBackendOK {
		t.Fatalf("summary = %+v", result.Summary)
	}
...
func TestAccountsCheckReadinessFailureIsDaemonSideAndSafe(t *testing.T) {
	...
	if partial.Summary.Ready || partial.Summary.CheckedAccounts != 1 || partial.Summary.MissingAccounts != 1 || partial.Summary.RouteCandidates != 1 || !partial.Summary.RouteDecisionOK {
...
func TestAccountsCheckRefreshFailureKeepsSuccessfulQuotaEvidence(t *testing.T) {
	...
	if partial.Summary.Ready || partial.Summary.FreshQuotaAccounts != 1 || partial.Summary.MissingQuotaAccounts != 1 || !partial.Summary.AutoRouteFresh || !partial.Summary.RouteDecisionOK {
...
func TestAccountsCheckAllFreshFailureReportsEveryStaleAccountSafely(t *testing.T) {
	...
	if partial.Summary.Ready || partial.Summary.CheckedAccounts != 2 || partial.Summary.FreshQuotaAccounts != 0 || partial.Summary.StaleQuotaAccounts != 1 || partial.Summary.MissingQuotaAccounts != 1 || !partial.Summary.RouteDecisionOK {
		t.Fatalf("partial summary = %+v", partial.Summary)
	}
	data, _ := json.Marshal(partial)
	for _, leaked := range []string{"test-token", "missing-token", "must-not-return", "secretRef", "file:codex", "CODEX_HOME", s.opts.RuntimeRoot} {
...
func TestAccountsCheckReadinessBackendMismatchAvoidsQuotaCalls(t *testing.T) {
	...
	if partial.Summary.Ready || partial.Summary.CheckedAccounts != 1 || partial.Summary.SecretBackendOK || partial.Summary.RequiredSecretBackend != secret.BackendNative || partial.Summary.RouteCandidates != 1 || !partial.Summary.RouteDecisionOK {
		t.Fatalf("partial summary = %+v", partial.Summary)
	}
...
func TestAccountsCheckReadinessSingleAccountFailureKeepsCheckedEvidence(t *testing.T) {
	...
	if partial.Summary.Ready || partial.Summary.CheckedAccounts != 1 || partial.Summary.FreshQuotaAccounts != 1 || !partial.Summary.AutoRouteFresh || !partial.Summary.RouteDecisionOK || !partial.Summary.SecretBackendOK {
		t.Fatalf("partial summary = %+v", partial.Summary)
	}
