...
| `capd accounts codex remove <account-id>` | Remove an imported Codex account, its cached quota/session bindings, current-account state, and its SecretStore token bundle. |
