...
verify-codex-readiness-sim:
	...
	go test ./internal/adapter/adaptertest ./internal/adapter/codex -run 'Test(ConformanceHelpers|CodexAdapterConformanceStaticContract|ProbeUsesResolvedCodexBinary)$$' -count=1
