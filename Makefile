...
verify-codex-readiness-sim:
	...
	go test ./cmd/capd -run 'Test(AccountsCheckReadinessShortcutSetsDaemonGateParams|AccountsCheckErrorNextStepsPreserveRequiredSecretBackend|DoctorReportsMultiAccountQuotaAndAutoRoute|DoctorChecksDaemonAccountsThroughCAP|DoctorSecretReadinessNextStepUsesSecretState|CodexAccountsSmokeRequireAllFreshQuota|CodexAccountsSmokeRequireMultipleReturnsPartialAccountEvidence|CodexAccountsSmokeSecretNextStepsPreserveSecretBackend|CodexAccountsSmokeTextIncludesAutoRouteEvidence|RouteCLIAccountAutoRequireFreshQuotaFailsWhenMissing|RouteCLIAccountAutoRequireFreshQuotaPassesWithFreshCache|CodexAccountsQuotaAllRefreshesEveryAccountSafely|CodexAccountsQuotaAllFailurePrintsSafePartialEvidence|ProbeDataTextPrintsReadinessSummary|ProbeDataTextPrintsPartialRouteCandidates|ProbeDataReadinessCanOverrideRequiredSecretBackend|HealthRequireSecretBackendFailsOnMismatch|SecretStoreCheckJSONRoundTrip|SecretStoreCheckFailsOnBackendMismatchAfterJSON|MigrateCodexAccountSecretsVerifiesTargetReadableBeforeMetadataUpdate|RunTaskFreshQuotaFailureSuggestsReadiness|ReferenceDocsCoverRunFreshQuotaRecovery|ReferenceDocsCoverBrowserTokenCleanup)$$' -count=1
