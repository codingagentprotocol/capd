...
.PHONY: build run test vet tidy verify verify-secretstore verify-codex-readiness-sim verify-codex-goal live-codex-repair-plan live-codex-repair-commands live-codex-preflight live-codex-readiness live-codex-selftest
...
verify-codex-readiness-sim:
	...
	go test ./internal/account -run 'Test(QuotaFromUsageRedactsSensitiveRawJSON|QuotaFromUsageNormalizesOutOfRangePercentsConservatively|QuotaSnapshotFreshRejectsInvalidPrimaryPercent|SelectQuotaRouteAccountTreatsInvalidQuotaAsUnknown|ConcurrentQuotaRefreshAndRouting|QuotaRouteEvidenceAndReason|RoutePolicyPenalizesRecentAccountFailures|RoutePolicyLongRunningPrefersFreshEvidenceOverUnknown|AccountStoreProfiles)$$' -count=1
	go test ./internal/server -run 'Test(AgentsRouteAutoAccountChoosesLowestCachedQuota|AgentsRouteAutoAccountRequireFreshQuota|AgentsRouteAutoAccountIgnoresStaleLowQuota|SessionCreateAutoAccountBindsLowestCachedQuota|SessionCreateFailureRecordsAccountHealthPenalty|ProfilesRPCManagesSafeGroupsAndRoutes|ClientDisconnectDoesNotEndLiveSessionAndReconnectCanContinue|AccountsCheckCanRefreshQuotaAndEnforceReadiness|AccountsCheckReadinessFailureIsDaemonSideAndSafe|AccountsCheckRefreshFailureKeepsSuccessfulQuotaEvidence|AccountsCheckAllFreshFailureReportsEveryStaleAccountSafely|AccountsQuotaAllRefreshesEveryCodexAccountSafely|AccountsQuotaAllFailureIsSafeAndCachesSuccessfulAccounts|ConcurrentAccountsQuotaAllAndFreshRoute|ProbeDataReturnsSafeAccountRouteEvidence|ProbeDataReadinessReturnsPartialEvidenceOnFailure|ProbeDataReadinessDefaultsToNativeAndAvoidsQuotaOnBackendMismatch|ProbeDataNextStepsUseRunnableNativeSecretStoreRetry|ProbeCredentialNextStepUsesSecretState|ProbeServedWithSecurityHeaders|ProbeValidationRowsStayUnique|ProbeDataRequiresAuthorizationHeader|ProbeDataAcceptsScopedProbeReadToken|BrowserPagesUseOneShotURLTokenAndHeaderAuth|ConsoleStaticContract|ConsoleApprovalRendererHasSingleBoxDeclaration|ScopedProbeTokenCannotCallSessionCreate|ScopedConsoleTokenAllowsFullConsoleWorkflow|ScopedConsoleReadTokenRejectsTaskControl|ScopedConsoleTokenCanDryRunRepairPlan|RepairRunExecuteUsesSafeRunner|ConsoleScopedTokenCanCreateSendAndCancelTaskOverWebSocket)$$' -count=1
	go test ./cmd/capd -run 'Test(AccountsImportNextStepPreservesEnvBackend|AccountsProfileCLIManagesSafeGroups|AccountsCheckReadinessShortcutSetsDaemonGateParams|AccountsCheckErrorNextStepsExplainSecretAccessDenied|AccountsCheckErrorNextStepsPreserveRequiredSecretBackend|AccountsCheckRefreshQuotaFailureDoesNotLeakSecrets|DoctorReportsMultiAccountQuotaAndAutoRoute|DoctorChecksDaemonAccountsThroughCAP|DoctorDaemonAccountsCheckUsesCallerTimeout|DoctorQuotaNextStepsPreferRouteSecretBackend|DoctorQuotaNextStepsHonorExplicitRequiredSecretBackend|DoctorSecretReadinessNextStepUsesSecretState|CodexAccountsSmokeRequireAllFreshQuota|CodexAccountsSmokeBackendMismatchNextSteps|CodexAccountsSmokeQuotaNextStepsPreserveSecretBackend|CodexAccountsSmokeRequireMultipleReturnsPartialAccountEvidence|CodexAccountsSmokeSecretNextStepsPreserveSecretBackend|CodexAccountsSmokeTextIncludesAutoRouteEvidence|CodexSmokeCachedAccountRowReportsSecretBackendMetadata|RouteCLIAccountAutoProfileConstrainsCandidates|RouteCLIAccountAutoRequireFreshQuotaFailsWhenMissing|RouteCLIAccountAutoRequireFreshQuotaPreservesEnvBackendInNextStep|RouteCLIAccountAutoRequireFreshQuotaPrefersAccountSecretBackendInNextStep|RouteCLIAccountAutoRequireFreshQuotaPassesWithFreshCache|RouteCLILongRunningTaskPrefersFreshEvidenceOverUnknown|CodexAccountsQuotaAllRefreshesEveryAccountSafely|CodexAccountsQuotaAllFailurePrintsSafePartialEvidence|ProbeDataTextPrintsReadinessSummary|ProbeDataTextPrintsPartialRouteCandidates|ProbeDataReadinessCanOverrideRequiredSecretBackend|ProbeEvidenceCmdSummarizesManifestArtifacts|ProbeEvidenceCmdFailsUnsafeAuditArtifact|ProbeEvidenceCmdJSONAndFail|ProbeEvidenceCmdWritesStandaloneHTMLReport|SupportBundleWritesSafeEvidencePackage|SupportBundleFailUsesEvidenceReport|HealthRequireSecretBackendFailsOnMismatch|SecretStoreCheckJSONRoundTrip|SecretStoreCheckFailsOnBackendMismatchAfterJSON|SecretStoreRoundTripNextStepsArePlatformSpecificAndSafe|MigrateCodexAccountSecretsVerifiesTargetReadableBeforeMetadataUpdate|RunTaskFreshQuotaFailureSuggestsReadiness|RunTaskFreshQuotaFailurePrefersRouteSecretBackend|RepairRunDryRunClassifiesManualAndRunnableSteps|RepairRunExecuteOnlyRunsRunnableSteps|ReferenceDocsCoverAccountListRouteAudit|ReferenceDocsCoverRouteCandidateEvidence|ReferenceDocsCoverProbeEvidence|ReferenceDocsCoverSecretStorePlatformRecovery|DocsCoverPromptFreeBrowserProbeRefresh|ReferenceDocsCoverRunFreshQuotaRecovery|ReferenceDocsCoverTaskAwareRouting|ReferenceDocsCoverBrowserTokenCleanup|EvidenceMatrixCoversCodexAccountPlaneGoal|ReadmeLinksEvidenceMatrix|DocsCoverVerifyCodexGoalTarget|VerifyCodexGoalTargetChainsLocalAuditGates)$$' -count=1
	go test ./internal/repairrunner -run 'TestRun(DryRunClassifiesSteps|ExecuteOnlyRunnableSteps|BoundsExecutedStepOutput|BoundsStepCountAndCommandSize)$$' -count=1
	go test ./internal/adapter/adaptertest ./internal/adapter/codex ./internal/adapter/claudecode ./internal/adapter/gemini ./internal/adapter/opencode ./internal/adapter/cursoragent -run 'Test(ConformanceHelpers|.*AdapterConformanceStaticContract|ClaudeCodeAdapterConformanceLifecycleFixture|ClaudeCodeAdapterConformanceResumeFixture|GeminiFamilyAdapterConformanceLifecycleFixture|OpenCodeAdapterConformanceLifecycleFixture|OpenCodeAdapterConformanceResumeFixture|CursorAgentAdapterConformanceLifecycleFixture|CursorAgentAdapterConformanceResumeFixture|ProbeUsesResolvedCodexBinary)$$' -count=1

verify-codex-goal: verify verify-codex-readiness-sim verify-secretstore
	@echo "Codex account-plane deterministic, simulated readiness, and SecretStore gates passed"
