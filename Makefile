...
verify-codex-readiness-sim:
	...
	go test ./cmd/capd -run 'Test(AccountsCheckReadinessShortcutSetsDaemonGateParams|DoctorReportsMultiAccountQuotaAndAutoRoute|DoctorChecksDaemonAccountsThroughCAP|CodexAccountsSmokeRequireAllFreshQuota|CodexAccountsSmokeTextIncludesAutoRouteEvidence|RouteCLIAccountAutoRequireFreshQuotaPassesWithFreshCache|CodexAccountsQuotaAllRefreshesEveryAccountSafely|ProbeDataTextPrintsReadinessSummary|ProbeDataReadinessCanOverrideRequiredSecretBackend|HealthRequireSecretBackendFailsOnMismatch|SecretStoreCheckJSONRoundTrip|MigrateCodexAccountSecretsVerifiesTargetReadableBeforeMetadataUpdate|RunTaskFreshQuotaFailureSuggestsReadiness|ReferenceDocsCoverRunFreshQuotaRecovery)$$' -count=1
