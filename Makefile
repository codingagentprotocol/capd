...
verify-codex-readiness-sim:
	...
	go test ./internal/adapter/adaptertest ./internal/adapter/codex ./internal/adapter/claudecode ./internal/adapter/gemini ./internal/adapter/opencode ./internal/adapter/cursoragent -run 'Test(ConformanceHelpers|.*AdapterConformanceStaticContract|ProbeUsesResolvedCodexBinary)$$' -count=1
