...
func main() {
	...
	root.AddCommand(newStartCmd(), newHealthCmd(), newDoctorCmd(), newConsoleCmd(), newProbeCmd(), newAgentsCmd(), newAccountsCmd(), newRunCmd(), newWatchCmd(), newSessionsCmd(), newServiceCmd(), newTokenCmd())
