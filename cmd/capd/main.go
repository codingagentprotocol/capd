...
func main() {
	...
	root.AddCommand(newStartCmd(), newHealthCmd(), newDoctorCmd(), newSecretStoreCmd(), newConsoleCmd(), newProbeCmd(), newAgentsCmd(), newAccountsCmd(), newRunCmd(), newWatchCmd(), newSessionsCmd(), newServiceCmd(), newTokenCmd())
