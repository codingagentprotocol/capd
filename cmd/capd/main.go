...
func main() {
	...
	root.AddCommand(newStartCmd(), newHealthCmd(), newDoctorCmd(), newConsoleCmd(), newAgentsCmd(), newAccountsCmd(), newRunCmd(), newWatchCmd(), newSessionsCmd(), newServiceCmd(), newTokenCmd())
